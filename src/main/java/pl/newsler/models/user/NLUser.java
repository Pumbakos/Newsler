...
//    private transient List<BusinessClient> businessClients;
    ...
    public NLUser(String name, String lastName, String email, String password, UserRole role, String appKey, String secretKey, String smtpAccount) {
        this.email = email;
        this.name = name;
    ...
    public NLUser(String name, String lastName, String email, String password, UserRole role) {
        this.email = email;
        this.name = name;
        this.password = password;
        this.lastName = lastName;
    ...
    public NLUser(String name, String email, String password, UserRole role) {
        this.email = email;
        this.name = name;
        this.password = password;
        this.role = role;
